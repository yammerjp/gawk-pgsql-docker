...
# Copy and apply patches for gd extension
COPY patches/gd_api_fix.patch /gawk-pgsql/gawkextlib/
COPY patches/gd_ellipse_functions.patch /gawk-pgsql/gawkextlib/
RUN cd gd && patch -p2 < ../gd_api_fix.patch && patch -p2 < ../gd_ellipse_functions.patch
